...
export const LinkItem = (props: LinkItemProps) => {
  ...
  return (
    <div className="p-5 flex flex-col gap-3 rounded-xl bg-light-grey">
      ...
      <div className="flex flex-col gap-1">
        ...
        <Input
          ...
          onChange={(e) => addLink(e.target.value, props.id)}
